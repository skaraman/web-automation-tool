...
```bash
git remote add encore encore://web-automation-tool-hcu2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/web-automation-tool-hcu2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/web-automation-tool-hcu2/settings/integrations/github)
